...
def tauSetup(tau_setup):
    ...
    return tau_config, is_adapt_local
...
def variablesSetup():
    ...
    return  (time_global_aggregation_all, total_time, total_time_recomputed, it_each_local, 
            it_each_global, is_last_round, is_eval_only, tau_new_resume, allGlobalLosses)
    ...
    for sim in sim_runs:
        ...
        for case in case_range:
            ...
            for tau_setup in tau_setup_all:
                ...
                # tau processing (adaptive or fixed)
                tau_config, is_adapt_local = tauSetup(tau_setup)

                if is_adapt_local or estimate_beta_delta_in_all_runs:
                    # use control algorithm to determine tau
                    if tau_setup == -1:
                ...
                (time_global_aggregation_all, total_time, total_time_recomputed,
                    ...
                    tau_new_resume, allGlobalLosses) = variablesSetup()
                # time_global_aggregation_all = None
